...
def snake(snakelist, direction):
    ...
    if direction == 'right':
        head = pygame.transform.rotate(snake2.png, 270)
        tail = pygame.transform.rotate(tail1.png, 270)
    if direction == 'left':
        head = pygame.transform.rotate(snake2.png, 90)
        tail = pygame.transform.rotate(tail1.png, 90)
    if direction == 'up':
        head = pygame.transform.rotate(snake2.png, 0)
        tail = pygame.transform.rotate(tail1.png, 0)
    if direction == 'down':
        head = pygame.transform.rotate(snake2.png 180)
        tail = pygame.transform.rotate(tail1.png, 180)
